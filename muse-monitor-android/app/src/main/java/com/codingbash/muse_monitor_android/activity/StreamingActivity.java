...
public class StreamingActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<StreamingActivity> weakActivity =
                new WeakReference<StreamingActivity>(this);
...
*/
    ...
    class MuseL extends MuseListener {
        final WeakReference<StreamingActivity> activityRef;

        MuseL(final WeakReference<StreamingActivity> activityRef) {
    ...
    class ConnectionListener extends MuseConnectionListener {
        ...
        ConnectionListener(final WeakReference<StreamingActivity> activityRef) {
            this.activityRef = activityRef;
        }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<StreamingActivity> activityRef) {
            this.activityRef = activityRef;
        }
